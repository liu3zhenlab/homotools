...
if (file.info(qrysvte)$size > 0) {
  ...
  if (nrow(qrysvte_data)>0) {
    kable(qrysvte_data, caption="SV and potential TEs")
  } else {
    cat("No SVs identified\n")
  }

  qrysvte_outfile <- paste0(cwd, "/", qrygene, "/", qrygene, "_", tgtbase, ".SV.txt")
  # output
...
if (file.info(tgtsvte)$size > 0) {
  ...
  if (nrow(tgtsvte_data)>0) {
    kable(tgtsvte_data, caption="SV and potential TEs")
  } else {
    cat("No SVs identified\n")
  }
} else {
