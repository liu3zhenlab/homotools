...
```
Nucmer was used to align sequences of the two genomes. Only uniquely aigned regions are displayed. Green: repetitive sequences; light blue: UTRs; blue: exons.

```{r polymorphism, echo=F, comment="", fig.height=3, fig.width=6, fig.cap="Fig 2"}
